/**
 * Fix Weekly Rate Calculations - JavaScript version
...
function calculateRealisticRates(dailyRate) {
  return {
    dailyRate,
...
`;
  ...
  console.log('Mini Digger 1.5T:  £742.50 → £322.00 weekly ✅ (-57%)');
