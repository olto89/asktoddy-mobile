...
function main() {
  ...
  try {
    ...
    functions.forEach(func => {
      ...
      console.log(`      Index file: ${func.indexFileExists ? 'Yes' : 'No'} (${func.indexFileSize} bytes)`);
    ...
    console.log(`   ${shared.envFileExists ? '✅' : '❌'} Environment utilities (${shared.envFileSize} bytes)`);
