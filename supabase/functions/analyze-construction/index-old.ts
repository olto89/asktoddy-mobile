...
// Initialize AI Middleware - REDUCED to prevent quota exhaustion
const middlewareConfig = {
  primaryProvider: 'gemini-simple',
  fallbackProviders: [], // DISABLED - Don't waste quota on fallbacks
  timeoutMs: 15000, // Shorter timeout for faster responses
  retryAttempts: 0, // NO RETRIES - Single attempt only to preserve quota
  enableFallback: false, // DISABLED - Prevent multiple provider attempts
  providerRetryDelay: 0, // No delays needed
