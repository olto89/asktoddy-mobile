...
export class LocationService {
  ...
  getUKRegion(location: LocationData): UKRegion {
    ...
    if (location.city) {
      ...
      if (cityLower.includes('manchester') || cityLower.includes('liverpool'))
        return UK_REGIONS.NORTH_WEST;
      if (cityLower.includes('birmingham') || cityLower.includes('coventry'))
        return UK_REGIONS.MIDLANDS;
      if (cityLower.includes('leeds') || cityLower.includes('sheffield'))
        return UK_REGIONS.YORKSHIRE;
      if (cityLower.includes('edinburgh') || cityLower.includes('glasgow'))
      ...
      if (cityLower.includes('brighton') || cityLower.includes('oxford'))
        return UK_REGIONS.SOUTH_EAST;
      if (cityLower.includes('cambridge') || cityLower.includes('norwich'))
        return UK_REGIONS.EAST_ANGLIA;
      if (cityLower.includes('newcastle') || cityLower.includes('sunderland'))
        return UK_REGIONS.NORTH_EAST;
    }
