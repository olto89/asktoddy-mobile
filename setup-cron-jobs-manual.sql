...
-- Manual Setup for pg_cron Jobs (Required for Production)
...
SELECT cron.schedule(
    ...
    SELECT extensions.http_post(
        'https://iezmuqawughmwsxlqrim.supabase.co/functions/v1/scheduled-tasks',
        '{"task": "daily-pricing"}',
        'application/json',
        '{"Authorization": "Bearer YOUR_SERVICE_ROLE_KEY_HERE"}'::jsonb
    );
    $$
);
...
-- SUCCESS MESSAGE
-- ============================================
SELECT 'Cron jobs configured successfully! 🎉' AS message;
